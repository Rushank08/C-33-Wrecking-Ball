...
function setup() {
  ...
  polygon = Bodies.circle(350,500,30);
  polygon.setVelocity = 6;
  World.add(world,polygon);
  
  // creating Constraint between polygon and point
  slingShot = new Slingshot(polygon, {x:350,y:100});

  stroke(255);
  
  // Stand1 
  stand1 = new Ground(675,650,1350,15);

 
  // creating blocks for stand1
  block01 = new Block(700,270);
  block02 = new Block(700,320);
  block03 = new Block(700,330);
  block04 = new Block(700,350);
  block05 = new Block(700,380);
  block06 = new Block(700,420);
  block07 = new Block(700,450);
  block08 = new Block(700,510);
  block09 = new Block(700,570);

  block001 = new Block(900,570);
  block002 = new Block(900,510);
  block003 = new Block(900,450);
  block004 = new Block(900,420);
  block005 = new Block(900,320);
  block006 = new Block(900,380);
  block007 = new Block(900,350);
  block008 = new Block(900,330);
  block009 = new Block(900,270);
